  ...
  async function handleSave() {
    ...
    try {
      ...
      if (Platform.OS === 'web') {
        ...
        showAlert('Thành công', 'Đã tạo bài viết mới.', 'success', () => router.back());
      }
    } catch (error) {
      console.error(error);
      const msg = error instanceof Error ? error.message : 'Lỗi không xác định';
      showAlert('Lỗi', `Không thể lưu bài viết: ${msg}`, 'error');
    } finally {
      setIsSaving(false);
    }
  }
    ...
    <View style={[styles.screen, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            setTitle('Lễ hội Sên Đôn-ta và nét đẹp báo hiếu của người Khmer');
            setCategory('Lễ hội');
            setSummary('Bài viết chi tiết về ý nghĩa tinh thần và văn hóa của lễ hội Sên Đôn-ta trong đời sống cộng đồng Khmer Nam Bộ.');
            setContent('Lễ hội Sên Đôn-ta (Lễ cúng ông bà) của đồng bào dân tộc Khmer là một trong những lễ hội truyền thống có ý nghĩa nhân văn sâu sắc, thể hiện lòng hiếu kính của con cháu đối với đấng sinh thành và tổ tiên. Diễn ra trong 3 ngày từ ngày 29 tháng 8 đến mùng 1 tháng 9 âm lịch, lễ hội là dịp để các thành viên gia đình quây quần bên nhau, cùng làm bánh, nấu cơm dâng cúng lên tổ tiên tại gia đình và mang lễ vật đến chùa làm lễ cầu siêu.\n\nTrong các ngày diễn ra lễ hội, các phum sóc Khmer tràn ngập không khí trang trọng và đầm ấm. Âm thanh rộn rã của dàn nhạc Ngũ âm vang lên khắp nơi, cùng với những điệu múa Lâm-thôn uyển chuyển làm gắn kết thêm tình làng nghĩa xóm.');
            setAuthor('Triệu Chanh Đa');
        ...
        >
          ...
          <ThemedText style={{ color: colors.primary, fontWeight: '700', fontSize: 13 }}>
            ✨ Chuẩn bị dữ liệu Demo (Bài viết)
          </ThemedText>
        </TouchableOpacity>
