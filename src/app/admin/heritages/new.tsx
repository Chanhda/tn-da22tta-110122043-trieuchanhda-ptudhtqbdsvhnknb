    ...
    <View style={[styles.screen, { backgroundColor: colors.background }]}>
      ...
      <Animated.View entering={FadeIn.duration(500)} style={[styles.header, { backgroundColor: colors.primary, paddingTop: Math.max(insets.top, 12) }]}>
        <View style={styles.headerTop}>
          ...
          <View style={styles.headerTitleBox}>
            <ThemedText style={styles.headerTitle}>Thêm di sản mới</ThemedText>
            <ThemedText style={styles.headerSub}>Điền các thông tin để tạo di sản</ThemedText>
          </View>
      ...
      >
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            setTitle('Chùa Hang (Kompong Chrây)');
            setType('tangible');
            setCategory('Kiến trúc tôn giáo');
            setProvince('Trà Vinh');
            setSubtitle('Ngôi chùa Hang cổ kính ẩn mình trong rừng cây dầu cổ thụ tại Trà Vinh.');
            setTag('Khám phá');
            setBody('Chùa Hang tọa lạc tại khóm 4, thị trấn Châu Thành, huyện Châu Thành, tỉnh Trà Vinh. Đây là một ngôi chùa Khmer cổ kính và có cảnh quan thiên nhiên vô cùng đẹp đẽ, là nơi trú ngụ của hàng ngàn cá thể chim cò các loại.');
            setDescription('Chùa Hang (tên gốc Kompong Chrây - tức Bến Cây Đa) được xây dựng từ thế kỷ 17 (năm 1637). Kiến trúc chùa mang đậm phong cách truyền thống của Phật giáo Nam tông Khmer với chánh điện uy nghiêm lợp ngói nhiều tầng uốn cong hình rồng thần Naga. Điểm độc đáo nhất là cổng vào chùa được thiết kế giống như một cái hang tự nhiên, bên trên có tháp cốt cao vút. Khuôn viên rộng 5 hecta rợp bóng mát của hàng trăm cây dầu cổ thụ, là nơi lí tưởng cho du khách và Phật tử tĩnh tâm tìm về nguồn cội.');
            setHighlightsInput('Kiến trúc cổng hang độc nhất vô nhị\nRừng cây cổ thụ hàng trăm năm tuổi\nNơi trú ngụ của đàn cò trắng tự nhiên');
            setLatInput('9.9042');
            setLngInput('106.3125');
            setCoverImage('');
          }}
          activeOpacity={0.7}
        >
        ...
        <Animated.View entering={FadeInDown.delay(150).duration(600)}>
          ...
          <View style={[styles.formCard, { backgroundColor: colors.backgroundSecondary, borderColor: colors.borderLight }]}>
            {/* Subtitle */}
            <View style={styles.inputGroup}>
              <ThemedText style={[styles.label, { color: colors.textSecondary }]}>Tiêu đề phụ / Tóm tắt ngắn</ThemedText>
              <TextInput
                style={[styles.input, { borderColor: colors.border, color: colors.text, backgroundColor: colors.background }]}
